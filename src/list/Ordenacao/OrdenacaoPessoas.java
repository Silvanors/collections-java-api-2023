...
public class OrdenacaoPessoas {
    ...
    //ordenar as pessoas usando o Comparable (há necessidade de ir na Classe Pessoa e implementar a interface
    // Comparable!!!)
    public List<Pessoa> ordenarPorIdade(){
        List<Pessoa> pessoasPorIdade = new ArrayList<>(pessoaList);
        //Collections consegue ordenar pelo método Comparable implementado na Classe Pessoa.
